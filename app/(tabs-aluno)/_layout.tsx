...
// Sem "Turmas" aqui — gerenciar turmas é uma função da Instituição, não do Aluno.
...
const VISIBLE_TABS = ['Home', 'Cardapio', 'Configuracoes'];

export default function TabsAlunoLayout() {
  return (
    <Tabs
      screenOptions={{
        headerShown: false,
